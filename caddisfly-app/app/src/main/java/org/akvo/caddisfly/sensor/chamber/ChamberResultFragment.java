...
public class ChamberResultFragment extends Fragment {

    /**
     * Get the instance.
     */
    public static ChamberResultFragment newInstance(TestInfo testInfo, boolean isInternal) {
        ChamberResultFragment fragment = new ChamberResultFragment();

...
package org.akvo.caddisfly.sensor.colorimetry.stripv2.instructions;
...
public class InstructionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePageLeft.setOnClickListener(v -> mViewPager.setCurrentItem(Math.max(0, mViewPager.getCurrentItem() - 1)));

        imagePageRight.setOnClickListener(v -> mViewPager.setCurrentItem(Math.min(fragments.size() - 1, mViewPager.getCurrentItem() + 1)));
